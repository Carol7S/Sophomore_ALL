...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam){
    ...
    switch(message){
        ...
        case WM_PAINT:
            ...
            if (i == 2)
            {
                hBr = CreateSolidBrush(RGB(255, 125, 0));
                SelectObject(hdc, hBr);
                hP = CreatePen(PS_SOLID, 1, RGB(255, 125, 0));
                SelectObject(hdc, hP);
                Rectangle(hdc, 0, 0, rect.right, rect.bottom);
            ...
            if (i == 3)
            {
                hBr = CreateSolidBrush(RGB(255, 225, 0));
                SelectObject(hdc, hBr);
                hP = CreatePen(PS_SOLID, 1, RGB(255, 225, 0));
                SelectObject(hdc, hP);
                Rectangle(hdc, 0, 0, rect.right, rect.bottom);
            ...
            if (i == 4)
            {
                hBr = CreateSolidBrush(RGB(0, 225, 0));
                SelectObject(hdc, hBr);
                hP = CreatePen(PS_SOLID, 1, RGB(0, 225, 0));
                SelectObject(hdc, hP);
                Rectangle(hdc, 0, 0, rect.right, rect.bottom);
            ...
            if (i == 5)
            {
                hBr = CreateSolidBrush(RGB(0, 0, 225));
                SelectObject(hdc, hBr);
            ...
            if (i == 6)
            {
                hBr = CreateSolidBrush(RGB(0, 225, 255));
                SelectObject(hdc, hBr);
                hP = CreatePen(PS_SOLID, 1, RGB(0, 225, 255));
                SelectObject(hdc, hP);
                Rectangle(hdc, 0, 0, rect.right, rect.bottom);

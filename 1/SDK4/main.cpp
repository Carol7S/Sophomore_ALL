...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam){
    ...
    switch(message){
        ...
        case WM_PAINT:
            ...
            MoveToEx(hdc, rect.left, rect.top, lpPoint);
            LineTo(hdc, (rect.left+rect.right)/16, rect.top);
            LineTo(hdc, rect.left, (rect.top+rect.bottom)/8);
            LineTo(hdc, (rect.left+rect.right)/16, (rect.top+rect.bottom)/8);
            //G
            hP = (HPEN) CreatePen(PS_SOLID, 10, RGB(255, 0, 0));
            hPenOld = (HPEN) SelectObject(hdc, hP);
            Arc(hdc, (rect.left+rect.right)/7,  (rect.top+rect.bottom)/7,
                    (rect.left+rect.right)/4, (rect.top+rect.bottom)/4,
                    (rect.left+rect.right)/5, (rect.top+rect.bottom)/8,
                (rect.left+rect.right)/5, (rect.top+rect.bottom)/3);
            MoveToEx(hdc, (rect.left+rect.right)/5, (rect.top+rect.bottom)/4, lpPoint);
            LineTo(hdc, (rect.left+rect.right)/5, (rect.top+rect.bottom)/5);
            //J
            hP = (HPEN) CreatePen(PS_SOLID, 10, RGB(255, 0, 0));
            hPenOld = (HPEN) SelectObject(hdc, hP);
            MoveToEx(hdc, (rect.left+rect.right)/2.5, (rect.top+rect.bottom)/3, lpPoint);
            LineTo(hdc, (rect.left+rect.right)/3, (rect.top+rect.bottom)/3);
            MoveToEx(hdc, (rect.left+rect.right)/2.75, (rect.top+rect.bottom)/3, lpPoint);
            LineTo(hdc, (rect.left+rect.right)/2.75, (rect.top+rect.bottom)/2);
            LineTo(hdc, (rect.left+rect.right)/2.9, (rect.top+rect.bottom)/2.2);
            //Y
            hP = (HPEN) CreatePen(PS_SOLID, 10, RGB(255, 0, 0));
            hPenOld = (HPEN) SelectObject(hdc, hP);
            MoveToEx(hdc, (rect.left+rect.right)/1.5, (rect.top+rect.bottom)/3, lpPoint);
            LineTo(hdc, (rect.left+rect.right)/1.4, (rect.top+rect.bottom)/2.5);
            LineTo(hdc, (rect.left+rect.right)/1.3, (rect.top+rect.bottom)/3);
            MoveToEx(hdc, (rect.left+rect.right)/1.4, (rect.top+rect.bottom)/2.5, lpPoint);
            LineTo(hdc, (rect.left+rect.right)/1.4, (rect.top+rect.bottom)/1.8);
